...
def main(checkpoint_path: str, config_path: str, eval_attacks: bool = True):
    ...
    validate_config(cfg)
    # Attacks use random initialization, so seed before evaluating or the
    # reported robust accuracy is not reproducible.
    ...
    *_, test_loader = get_cifar10_loaders(
    ...
    if eval_attacks:
        ...
        pgd = PGDAttack(model, epsilon=cfg.attack.epsilon, alpha=cfg.attack.alpha, num_steps=20)
